...
> - `supabase/migrations/20260424100000_stagionale_disponibilita_tx.sql` — la policy `transazioni_insert` ora ammette inserimenti informativi (`disponibilita_aggiunta`/`disponibilita_rimossa`, `importo IS NULL`) dallo stagionale sul proprio `cliente_id`.
